...
add_action('plugins_loaded', static function (): void {
    $required = [
        ...
        'includes/class-wpaib-oauth.php',
    ...
    if (class_exists('WPAIB_OAuth')) WPAIB_OAuth::boot();
    if (class_exists('WPAIB_Updater')) WPAIB_Updater::boot();
    if (class_exists('WPAIB_Settings')) WPAIB_Settings::boot();
    if (class_exists('WPAIB_REST')) WPAIB_REST::boot();
    if (class_exists('WPAIB_MCP')) WPAIB_MCP::boot();
});
